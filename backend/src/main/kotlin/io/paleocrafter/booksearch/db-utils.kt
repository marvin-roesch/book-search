...
import io.paleocrafter.booksearch.JsonbColumnType.Companion.JSONB
import io.paleocrafter.booksearch.JsonbColumnType.Companion.MAPPER
...
inline fun <reified T : Any> Table.jsonb(name: String): Column<T> =
    jsonb(name, { MAPPER.writeValueAsString(it) }, { MAPPER.readValue(it, T::class.java) })
